...
// route pour la pages stagiaires
Route::get('/stagiaires', [InternController::class, 'index'])->name('stagiaires.index');


//route pour le profile 

Route::get('/profile', [InternController::class, 'showProfile'])->name('profile');
Route::put('/profile/update', [InternController::class, 'updateProfile'])->name('profile.update');
