...
const uploadCINButton = document.getElementById("uploadCINButton");

uploadCINButton.addEventListener("click", function () {
  cinInput.click();
});

// Demande Upload
const demandeInput = document.getElementById("demande");
const uploadDemandeButton = document.getElementById("uploadDemandeButton");

uploadDemandeButton.addEventListener("click", function () {
  demandeInput.click();
});

// CV file name display
cvInput.addEventListener("change", function () {
  document.getElementById("cvFileName").textContent = cvInput.files[0]?.name || "";
});

// CIN file name display
cinInput.addEventListener("change", function () {
  document.getElementById("cinFileName").textContent = cinInput.files[0]?.name || "";
});

// Demande file name display
demandeInput.addEventListener("change", function () {
  document.getElementById("demandeFileName").textContent = demandeInput.files[0]?.name || "";
});
