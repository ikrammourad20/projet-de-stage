...
function editIntern(button) {
  ...
  var level = row.cells[6].innerText;
  var phone = row.cells[7].innerText;
  var address = row.cells[8].innerText;
  var school = row.cells[9].innerText;
  var sector = row.cells[10].innerText;
  var supervisor = row.cells[11].innerText;
  var startDate = row.cells[12].innerText;
  var endDate = row.cells[13].innerText;
